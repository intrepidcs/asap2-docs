...
const config = {
  ...
  projectName: 'asap2-docs', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          routeBasePath: '/',
          editUrl:
            'https://github.com/intrepidcs/asap2-docs/blob/main/',
        },
        // blog: {
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/asap2-social-card.jpg',
      navbar: {
        title: 'ASAP2 Editor Help Documentation',
        logo: {
          alt: 'ASAP2 Editor Help Documentation Logo',
          src: 'img/logo.svg',
          width: 32,
          height: 32,
        ...
        items: [
          ...
          {
            href: 'https://github.com/intrepidcs/asap2-docs',
            label: 'GitHub',
            position: 'right',
          },
        ],
